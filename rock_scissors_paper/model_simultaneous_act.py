import mesa
from .patch_simultaneous_act import PatchSimultaneosActivation
from mesa.datacollection import DataCollector

class RockScissorsPaperSimultaneousActivation(mesa.Model):
    """
    ...
    def __init__(self, hex_grid, init0, init1, init2, init3, init4, n_species, color_map, width=50, height=50):
        """
        ...
        if self.n_species == 3:
            ...
            self.threshold = 2 if self.hex_grid else 3
        ...
        for _, (x, y) in self.grid.coord_iter():
            ...
            patch = PatchSimultaneosActivation(pos=(x, y), model=self, init_state=patch_init_state)
