...
class RockScissorsPaperSSR(mesa.Model):
    ...
    def __init__(self, hex, prob0, prob1, prob2, prob3, prob4, prob5, n_species, color_map, width=50, height=50):
        """
        ...
        if self.n_species == 3:
            ...
            self.probabilities = [prob0, prob1, prob2, prob3, prob4, prob5]
